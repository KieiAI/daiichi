...
from app.services.auth_service import AuthService # REVOKED_ACCESS_TOKENS, REVOKED_REFRESH_TOKENS は削除された
...
class AuthUseCase:
    ...
    #     try:
    #         # Google ID Tokenの検証
    #         google_payload = jwt.decode(id_token, options={"verify_signature": False}) # 開発中は署名検証をスキップ可（非推奨）
